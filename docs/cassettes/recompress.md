...
_Given_ a file named "recompress.rb" with:
...
_When_ I append to file "recompress.rb":
...
_And_ I run `ruby recompress.rb`

_Then_ it should pass with "Content-Encoding: none".
...
_Then_ it should pass with "Content-Encoding: gzip".

## The recompressing happens after replacing filtered sensitive data
...
_Then_ it should pass with "The quick brown fox jumps over the lazy dog".
