...
NOTE: To avoid storing any sensitive information in cassettes, check out [Filter Sensitive Data](https://nicolasiensen.gitbook.io/vcr/configuration/filter_sensitive_data) in the documentation.
