Feature: Replay recorded response
  ...
  Scenario: Replay recorded response for a request in a VCR.with_sandbox block
  ...
  Scenario: Replay recorded response for a request within a tagged scenario
    Given this scenario is tagged with the vcr sandbox tag: "@replay_sandbox1"
  ...
  Scenario: Use both a tagged scenario sandbox and a nested sandbox within a single step definition
    Given this scenario is tagged with the vcr sandbox tag: "@replay_sandbox2"
